...
struct NativeInstruction {
  ...
  bool has_ref_info;                                    // added

  bool has_delay_slot; // if the instruction has delay slot or not.
  bool is_delayed; // wheather the instruction is inside a delay slot or not.
};
